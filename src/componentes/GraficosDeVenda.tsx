...
function transformadorDeData(data: IProduto[]): VendaDia[] {
...
const GraficosDeVenda = ({ data }: { data: IProduto[] }) => {
  const dataTransformada = transformadorDeData(data);
  return (
...
export default GraficosDeVenda;
